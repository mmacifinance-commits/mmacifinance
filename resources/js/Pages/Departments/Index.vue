                    ...
                    <tr v-for="d in departments" :key="d.id" class="border-b border-gray-100 hover:bg-gray-50/50">
                        ...
                        <td class="px-5 py-3 text-center text-gray-600">
                            <div class="flex flex-wrap justify-center gap-1.5 max-w-xs mx-auto">
                                <span v-for="p in d.particulars" :key="p.id" class="rounded bg-gray-100 px-2 py-0.5 text-xs text-gray-700">
                                    {{ p.particular }}
                                </span>
                        ...
                        <td v-if="perms.canManageBudget" class="px-5 py-3 text-center">
                            <button @click="openEdit(d)" class="text-blue-600 hover:text-blue-800 font-medium mr-3 transition">Update</button>
