...
function visibleParticulars(department) {
    return (department.particulars || []).slice(
        0,
        MAX_VISIBLE_TITLES
    )
}
...
function save() {
    if (editing.value) {
        form.put(`/departments/${editing.value}`, {
            onSuccess: () => {
...
function remove(id) {
    if (
        confirm(
            'Warning: this cannot be undone. Delete this responsibility center?'
        )
    ) {
...
<template>
    ...
    <AppLayout>
        ...
        <div class="mb-6 flex items-center justify-between gap-4">
            <div class="min-w-0">
                ...
                <p class="text-sm text-gray-500">
                    Manage programs and centers used across account titles,
                    budgets, expenses, and reports.
                </p>
            </div>
        ...
        >
            Head of Finance only can add, edit, or delete responsibility
            centers.
        </div>
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td class="px-5 py-4 align-middle">
                                <span
                                    class="inline-block rounded-md bg-navy/10 px-2.5 py-1 text-xs font-semibold text-navy"
                                >
                                    {{ department.code }}
                                </span>
                            </td>
                            ...
                            >
                                <div
                                    v-if="
                                        ...
                                        department.particulars.length
                                    "
                                    class="mx-auto flex max-w-[520px] flex-wrap justify-center gap-1.5"
                                >
                                    <span
                                        v-for="particular in visibleParticulars(department)"
                                        :key="particular.id"
                                    ...
                                    <span
                                        v-if="
                                            ...
                                            MAX_VISIBLE_TITLES
                                        "
                                        :title="`${department.particulars.length} total Account Titles`"
        ...
        <!-- Add/Edit Responsibility Center Modal -->
        <Modal
            :show="showModal"
            :title="
                editing
            ...
            :subtitle="
                editing
                    ? 'Update responsibility center details.'
            ...
            >
                ...
                >
                    ...
                    <p class="mt-2 text-xs">
                        Responsibility Centers are used by Account Titles and
                        Annual Budget Allocations. Codes should be short and
                        unique, like FIN.
                    </p>
                </div>
