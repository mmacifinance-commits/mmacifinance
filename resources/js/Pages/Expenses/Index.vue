                ...
                <tbody>
                    ...
                    >
                        ...
                        <td v-if="perms.canManageExpenses" class="px-5 py-5 text-center align-middle">
                            <button @click="openEdit(e)" class="text-blue-600 hover:text-blue-800 font-medium mr-3 transition" :disabled="e._offline" :class="{ 'opacity-40 cursor-not-allowed': e._offline }">Update</button>
                            <button @click="remove(e.id)" class="text-red-600 hover:text-red-800 font-medium transition">Delete</button>
                        </td>
                    </tr>
