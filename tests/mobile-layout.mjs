...
try {
    ...
    for (const width of [320, 390, 768, 1440]) {
        ...
        for (const route of ['/', '/iaeo', '/annual-budgets', '/annual-budgets/1', '/departments', '/budget-categories', '/budget-particulars', '/income', '/receipts', '/expenses', '/disbursements', '/reports', '/reports/generate']) {
